...
public class Join extends Activity implements BinaryDataOperation{



	private final ActivityType type = ActivityType.JOIN;
	...
	public Join(String id, String unifiedName, String eqOperator, 
	...
	public String toASMString() {
		return String.format("%s := comp.join(%s, %s, %s %s %s) //%s", this.unifiedName, this.scope1, this.scope2, this.leftParamName, this.eqOperator ,this.rightParamName, this.toString());
	}
	@Override
	...
	@Override
	public Join clone() {
		return new Join(this.getId(), this.unifiedName, this.eqOperator, this.leftServiceName, this.leftMethodName, this.leftParamName, this.rightServiceName, this.rightMethodName, this.rightParamName);
	}
}
